...
export default function About() {
  ...
  const handleVideoEnd = () => {
    // Scroll to the content below the video
  ...
  return (
    <section id="salon" className="scroll-mt-20">
      ...
      <AnimatedSection className="w-full mb-16">
        <div className="relative w-screen overflow-hidden" style={{ marginLeft: 'calc(-50vw + 50%)' }}>
          <video
            ref={videoRef}
          ...
          >
            <source src="/Reveal/Video Project.mp4" type="video/mp4" />
